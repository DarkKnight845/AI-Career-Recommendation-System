...
if __name__ == "__main__":
    try:
        ...
        df = pd.read_csv(
            r"C:\Users\ayemi\OneDrive\Documents\Team4\Backend\data\careers_dataset.csv"
        )
        ...
        print(
            "Error: 'unified_career_dataset.csv' not found. Please ensure the file is in the same directory."
        )
